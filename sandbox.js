// arrays
var names = ["kashyap", "chintan", "maitu"];
...
numbers.push(50);
var mixed = ["name", 34, "AToZ", 45]; // now this array is contain mixed value('string' and 'numbers'), here in this array we pushed 'string' and 'number' both in the same array.
mixed.push("reveu");
mixed.push(40);
// objects
var ninja = {
